...
void Window::tabChanged ( int index )
{
  if ( index != -1 )
  {
    ...
    {
      QString notice ( "<!-- " );
      notice.append ( trUtf8 ( "Warning: This is not the real Sourcecode, it was generated by WebKit and will produce tidy failures." ) );
      notice.append ( " -->\n" );
      notice.append ( "<!-- " );
      notice.append ( trUtf8 ( "To see the real sourcecode click reload page for xhtmldbg cached http responsed source." ) );
      notice.append ( " -->\n" );
