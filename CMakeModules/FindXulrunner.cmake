...
SET (XULRUNNER_FOUND 0)

MESSAGE (STATUS "Looking for Xulrunner")
...
IF (_PC_XULRUNNER_FOUND AND XULRUNNER_INCLUDE_DIR)
  ...
  IF (NOT XULRUNNER_FIND_QUIETLY)
    MESSAGE (STATUS " Found libraries : ${XULRUNNER_LIBRARIES}")
    MESSAGE (STATUS " Found includes  : ${XULRUNNER_INCLUDES}")
    MESSAGE (STATUS " Found defines   : ${XULRUNNER_DEFINITIONS}")
    MESSAGE (STATUS " Found version   : ${XULRUNNER_VERSION}")
